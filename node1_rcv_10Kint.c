...
// returns 0 on success , 1 for failure because mae bi ek failure e ho :(
...
// sending results and waiting for receive completion 
// returns 0 on success , 1 on failure ->jaisa k meri trha k failure *
